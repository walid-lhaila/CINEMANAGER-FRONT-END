...
function SessionForm({removeForm}) {
                    ...
                    <form className="w-[100%]">
                        ...
                        <div className=" flex justify-center items-center gap-2 py-4 ">
                            ...
                            <div className="w-[40%]">
                                ...
                                <input name="endTime"
                                       className="block font-serif w-full text-md py-2.5 px-3 border border-gray-900 rounded cursor-pointer  placeholder:text-gray-400"
                                       type="datetime-local"/>
                            </div>
                        </div>
                        <div className=" flex justify-center items-center gap-2 ">
                            <div className="w-[40%]">
                                ...
                                <input placeholder="50$" name="price"
                                       className="block w-full text-md py-2.5 px-3 border border-gray-900 rounded cursor-pointer  placeholder:text-gray-400"
                                       type="number"/>
                            </div>
                            <div className="w-[40%]">
                                ...
                                <ul className="items-center w-full h-[40px] gap-1  text-sm font-medium text-gray-900 bg-white  rounded-lg sm:flex dark:text-white">
                                    ...
                                    <li className="w-full border border-gray-600 rounded sm:border  sm:border">
                                        <div className="flex items-center ps-3">
                                            <input id="horizontal-list-radio-id" type="radio" value="false" name="list-radio"
